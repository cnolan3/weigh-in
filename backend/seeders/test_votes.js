...
module.exports = {
  up: (queryInterface, Sequelize) => {
    return queryInterface.bulkInsert('votes', [
      ...
      { id: 7, vote: 1, createdAt: new Date(), updatedAt: new Date(), debateId: 2, userUsername: 'bbb' },
      { id: 8, vote: 0, createdAt: new Date(), updatedAt: new Date(), debateId: 2, userUsername: 'bbb' },
